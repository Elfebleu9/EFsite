...
class PagesController extends AbstractController
{
    ...
    */
    ...
    /**
     * @Route("/pagesAd/{id<[0-9]+>}", name="app_pages_show",methods="GET")
     */
    ...
    /**
     * @Route("/pagesAd/{id<[0-9]+>}/edit", name="app_pages_edit",methods={"GET", "POST"})
     */
    public function edit(Extrait $extrait): Response
    {
        return $this->render('pagesAd/edit.html.twig', compact('extrait'));
    }
}
