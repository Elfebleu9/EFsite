...
let audio = document.querySelectorAll('#audiopl');
// let juice = document.querySelectorAll('.orange-juice');
// let btn = document.getElementById('play-pause');
let volumeslider = document.getElementById('volumeSlider');
// let orangeBar = document.querySelectorAll('.orange-bar');

// $('#audiopl').html('<audio src="{{extrait.morceau,{id:extrait.id}}}" crossOrigin="anonymous" preload="auto" type="audio/mp3"></audio>');
